...
PRVM_DECLARE_clientfunction(CSQC_Input_Frame)
...
PRVM_DECLARE_clientglobalvector(input_aimangles)
...
PRVM_DECLARE_function(m_drawloading)
PRVM_DECLARE_function(m_startload)
PRVM_DECLARE_function(m_endload)
...
PRVM_DECLARE_global(input_aimangles)
...
PRVM_DECLARE_global(loading_amount_min)
PRVM_DECLARE_global(loading_amount_len)
PRVM_DECLARE_global(loading_amount)
PRVM_DECLARE_global(loading_message)
...
PRVM_DECLARE_menufunction(m_startload)
PRVM_DECLARE_menufunction(m_endload)
...
PRVM_DECLARE_menuglobalstring(mapname)
PRVM_DECLARE_menuglobalfloat(loading_amount_min)
PRVM_DECLARE_menuglobalfloat(loading_amount_len)
PRVM_DECLARE_menuglobalfloat(loading_amount)
PRVM_DECLARE_menuglobalstring(loading_message)
...
PRVM_DECLARE_serverfieldfloat(movechain)
...
PRVM_DECLARE_serverfieldfunction(chainmoved)
...
PRVM_DECLARE_serverglobalvector(input_aimangles)
